...
function PANEL:Init()
	self.move = -(mp.szmp*0.016194331983806)
end
...
function PANEL:Paint(w,h)
	...
	if self:IsHovered() then
		...
		surface_DrawTexturedRectRotated(self.move, h/2, (mp.szmp*0.12955465587045), (mp.szmp*0.12955465587045), 0)
	else
	...
	if self:GetButtonImage() then
		...
		surface_DrawTexturedRectRotated(w/2, h/2, (mp.szmp*0.019433198380567), (mp.szmp*0.019433198380567), 0)
	else
...
vgui.Register( "mp.button", PANEL,"Button")
