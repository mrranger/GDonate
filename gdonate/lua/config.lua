-- THEME
mp.c.api_url = "https://example.net/newdonte/" -- API URL
mp.c.maincolor = Color(170,170,170,180)
mp.c.addcolor = Color(49,10,80,250)
mp.c.closehover = Color(255,30,30,250)
mp.c.buttoncolor = Color(69,50,110,250)
mp.c.buttonhovercolor = Color(79,60,120,250)
mp.c.events = {
  ["combines"] = true,
}

mp.c.itembg = Color(30,30,30,200)
mp.c.await = 5
mp.Create("vip")
:SetName("VIP")
:SetDescription([[
...
mp.Create("weapon_vape_medicinal")
